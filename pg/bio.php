    ...
    <body>
        ...
        <main>
			...
			<div class="texto">
				...
				<blockquote class="citacao-bio petrobras"><p>
					João domina as tecnologias como ninguém. Eu apresentava um problema, ele tinha na ponta da língua a solução mais adequada com as tecnologias mais recentes.</p>
		...
		<aside class="navegacao-site">
			...
			<nav>
				<ul>
					...
					<li><a href="bio.php">Sobre mim</a></li>
